import{M as q,aB as J,N as K,aC as Q,R as Y,aE as ee,a as s,ah as w,P as te,m as ae,aA as ie,ao as re,A as B,an as se,x as ne,n as oe,B as le,H as ce}from"./mermaid-vendor-DknyUGWt.js";import{p as de}from"./chunk-4BX2VUAB-Dm1Nxvlh.js";import{p as pe}from"./wardley-L42UT6IY-CH7596wU.js";import"./markdown-vendor-BU83kELG.js";var ge=ce.pie,C={sections:new Map,showData:!1},u=C.sections,D=C.showData,he=structuredClone(ge),ue=s(()=>structuredClone(he),"getConfig"),fe=s(()=>{u=new Map,D=C.showData,oe()},"clear"),me=s(({label:e,value:a})=>{if(a<0)throw new Error(`"${e}" has invalid value: ${a}. Negative values are not allowed in pie charts. All slice values must be >= 0.`);u.has(e)||(u.set(e,a),w.debug(`added new section: ${e}, with value: ${a}`))},"addSection"),ve=s(()=>u,"getSections"),xe=s(e=>{D=e},"setShowData"),Se=s(()=>D,"getShowData"),F={getConfig:ue,clear:fe,setDiagramTitle:ee,getDiagramTitle:Y,setAccTitle:Q,getAccTitle:K,setAccDescription:J,getAccDescription:q,addSection:me,getSections:ve,setShowData:xe,getShowData:Se},we=s((e,a)=>{de(e,a),a.setShowData(e.showData),e.sections.map(a.addSection)},"populateDb"),Ce={parse:s(async e=>{const a=await pe("pie",e);w.debug(a),we(a,F)},"parse")},De=s(e=>`
  .pieCircle{
