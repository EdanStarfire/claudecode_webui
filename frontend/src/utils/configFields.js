...
export const FIELD_DEFAULTS = Object.freeze({
  ...
  auto_mode_environment: null,
  auto_mode_allow: null,
  auto_mode_soft_deny: null,
  auto_mode_hard_deny: null,
  auto_mode_classify_all_shell: null,
  cli_path: null,
...
const _FIELD_TO_AREA = Object.freeze({
  ...
  auto_mode_environment: 'permissions',
  auto_mode_allow: 'permissions',
  auto_mode_soft_deny: 'permissions',
  auto_mode_hard_deny: 'permissions',
  auto_mode_classify_all_shell: 'permissions',
  // system_prompt
