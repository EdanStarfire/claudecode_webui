...
Templates are appended to the Claude Code preset system prompt to provide
Legion-specific guidance while preserving core Claude Code functionality.
"""

from typing import Dict, Any, Optional


# Legion MCP Tools Usage Guide
# This template is appended to the Claude Code preset for all minions
LEGION_MCP_TOOLS_GUIDE = """
...
def build_minion_system_prompt(initialization_context: str = "") -> Dict[str, Any]:
    ...
    append_content_parts = [LEGION_MCP_TOOLS_GUIDE]
...
def get_legion_guide_only() -> str:
    ...
    Returns:
        str: The Legion MCP tools guide template

    Use this for documentation or testing purposes.
    """
    return LEGION_MCP_TOOLS_GUIDE
