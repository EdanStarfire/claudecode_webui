...
def test_route_count_unchanged():
    ...
    assert len(api_routes) == 132, (
        f"Expected 132 routes (+1 usage from #1125, +1 edit-history from #1128, +3 audit from #1127, +1 analytics from #1132, -2 legacy images from #1261, +1 oauth import-as-secret from #1381), got {len(api_routes)}. "
