...
from backend.models.minion_template import MinionTemplate
...
from backend.template_manager import TemplateConflictError, TemplateInUseError, TemplateManager
...
class TestMinionTemplateRoundTrip:
    ...
    def test_effort_max_normalizes_to_high(self):
        ...
        """
        from backend.template_manager import _migrate_template_to_config_dict
...
class TestImportFieldPreservation:
    ...
    async def test_import_preserves_all_session_config_fields(self, manager):
        ...
        from backend.models.minion_template import MinionTemplate as MinionTemplateModel
