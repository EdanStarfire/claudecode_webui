...
Skills are stored in backend/default_skills/ and synced to ~/.config/cc_webui/skills/
...
class SkillManager:
    ...
    3. Copy skill directories from backend/default_skills/ to ~/.config/cc_webui/skills/
